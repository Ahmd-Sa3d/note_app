        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                'first note details',
                style: AppFonts.poppins(fontSize: 13, color: AppColors.black.withAlpha(120)),
              ),
              trailing: IconButton(onPressed: () {}, icon: Icon(Icons.delete,color: AppColors.black,)),
            ),
            Padding(
              padding: const EdgeInsets.only(right: 20.0),
              child: Text(
                '30/12/2026',
                style: AppFonts.poppins(fontSize: 10, color: AppColors.black.withAlpha(120)),
              ),
            ),
          ],
        ),
